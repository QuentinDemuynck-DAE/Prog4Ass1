...
void dae::ShootPepperCommand::Execute()
{
	...
	if (!m_PlayerComponent->GetIsShooting())
	{
		...
		pepper->AddComponent<CollisionComponent>(*dae::Minigin::physicsWorld.get(), dae::CollisionLayers::SALT, dae::CollisionLayers::ENEMY , glm::vec2{ 8, 8 }, glm::vec2{ 0, 0 }, true, false);
